<template>
  <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
    ...
    >
      ...
      <div class="flex space-x-2 mt-2">
        <img
          ...
          @mouseleave="card.currentImage = card.originalImage"
        />
      </div>
  ...
  data() {
    return {
      cards: [
        {
          currentImage:
            "https://img1-newbalance.mncdn.com/mnpadding/480/480/FFFFFF/newbalance/products/NBU998TI_1.jpg",
          originalImage:
            "https://img1-newbalance.mncdn.com/mnpadding/480/480/FFFFFF/newbalance/products/NBU998TI_1.jpg",
          hoverImage:
            "https://img1-newbalance.mncdn.com/mnpadding/480/480/FFFFFF/newbalance/products/NBU998TI_2.jpg",
          thumbnails: [
            "https://img1-newbalance.mncdn.com/mnpadding/480/480/FFFFFF/newbalance/products/NBU998TI_1.jpg",
          ],
        ...
        },
        {
          ...
          thumbnails: [
            "https://img1-newbalance.mncdn.com/mnpadding/480/480/FFFFFF/newbalance/products/NBM2002RXU_1.jpg",
            "https://img1-newbalance.mncdn.com/mnpadding/480/480/FFFFFF/newbalance/products/NBM2002RXT_1.jpg",
          ],
