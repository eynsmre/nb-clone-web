<template>
  <div>
    <div>
      <button class= ""v-for="component in components" :key="component.name" @click="showComponent(component.name)">
        {{ component.label }}
      </button>
    </div>
    ...
    <div>
      ...
      <ComponentG v-if="currentComponent === 'ComponentG'" />
